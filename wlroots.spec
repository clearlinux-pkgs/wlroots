...
Source0  : https://gitlab.freedesktop.org/wlroots/wlroots/-/archive/0.17.0/wlroots-0.17.0.tar.gz
...
%prep
%setup -q -n wlroots-0.17.0
cd %{_builddir}/wlroots-0.17.0
pushd ..
cp -a wlroots-0.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701123927
