...
Version  : 0.16.1
Release  : 17
URL      : https://gitlab.freedesktop.org/wlroots/wlroots/-/archive/0.16.1/wlroots-0.16.1.tar.gz
Source0  : https://gitlab.freedesktop.org/wlroots/wlroots/-/archive/0.16.1/wlroots-0.16.1.tar.gz
...
%prep
%setup -q -n wlroots-0.16.1
cd %{_builddir}/wlroots-0.16.1
pushd ..
cp -a wlroots-0.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672156649
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/glibc-hwcaps/x86-64-v3/libwlroots.so.11
