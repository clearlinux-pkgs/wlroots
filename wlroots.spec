...
Version  : 0.13.0
Release  : 6
URL      : https://github.com/swaywm/wlroots/archive/0.13.0/wlroots-0.13.0.tar.gz
Source0  : https://github.com/swaywm/wlroots/archive/0.13.0/wlroots-0.13.0.tar.gz
...
%prep
%setup -q -n wlroots-0.13.0
cd %{_builddir}/wlroots-0.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621444549
...
cp %{_builddir}/wlroots-0.13.0/LICENSE %{buildroot}/usr/share/package-licenses/wlroots/cf7d4b8dccadb7713df91a14a5d9f5b53f493f3c
cp %{_builddir}/wlroots-0.13.0/tinywl/LICENSE %{buildroot}/usr/share/package-licenses/wlroots/df855b408256fed71fe29eb1382d03841508d0f2
