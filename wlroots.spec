...
Version  : 0.17.2
Release  : 27
URL      : https://gitlab.freedesktop.org/wlroots/wlroots/-/archive/0.17.2/wlroots-0.17.2.tar.gz
Source0  : https://gitlab.freedesktop.org/wlroots/wlroots/-/archive/0.17.2/wlroots-0.17.2.tar.gz
...
%prep
%setup -q -n wlroots-0.17.2
cd %{_builddir}/wlroots-0.17.2
pushd ..
cp -a wlroots-0.17.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710189352
